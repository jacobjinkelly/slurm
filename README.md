...
## Requirements
Python scripts are configured to use the system installation of Python3 (`#!/usr/bin/python3`). As such they only use standard libraries, and are compatible with Python 3.6 or higher. Other scripts use bash.
